...
- **Don't loop on the same error.** If a script fails and you've tried to fix it twice without success, simplify your approach or write a `[BLOCKER]` and hand off. Do not make the same fix three times.
